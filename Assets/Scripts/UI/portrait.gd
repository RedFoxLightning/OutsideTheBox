...
func _input(event: InputEvent) -> void:
	...
	if Input.is_action_pressed("Grab") and !disabled and canGrab and !grabbed and gameManager.pauseMenu.current_screen == pause_menu.paused_screen.info:
